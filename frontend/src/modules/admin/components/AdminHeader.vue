<template>
  ...
  <div class="md:hidden sticky top-16 left-0 right-0 z-40 border-b px-4 py-3 flex items-center" :class="darkMode ? 'bg-custom-surface-dark border-white/[0.05]' : 'bg-white border-gray-200'">
    <button
      type="button"
